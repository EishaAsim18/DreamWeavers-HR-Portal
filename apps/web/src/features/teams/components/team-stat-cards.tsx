...
const STAT_CONFIG = [
  {
    ...
    label: 'Teams',
    icon: '🧩',
    gradient: 'from-[#7c3aed]/15 via-[#f3edfb] to-[#7c3aed]/5',
  ...
  },
  {
    ...
    beamFrom: '#4a7c92',
    beamTo: '#7ab5cc',
    spotlight: 'rgba(74,124,146,0.12)',
  },
  {
    key: 'managers',
    label: 'Managers',
...
export function TeamStatCards({ stats }: TeamStatCardsProps) {
  return (
          ...
          >
            ...
            <div className="relative flex items-center gap-3 px-3.5 py-3">
              ...
              <div>
                <NumberTicker
                  value={stats[cfg.key]}
                  decimalPlaces={cfg.key === 'avgSize' ? 1 : 0}
